# Generated by Django 3.2.9 on 2023-03-31 12:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dostawca', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dost_podkarpacka', to='common.dostawcy')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='LicznikDostawyPodkarpacka',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ID_DYS', models.PositiveSmallIntegerField()),
                ('ID_WAZ', models.PositiveSmallIntegerField()),
                ...
                ('KIEDY', models.CharField(max_length=150)),
                ('KIEDY_WGR', models.DateTimeField(auto_now=True)),
                ('number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dost_licz_podkarpacka', to='podkarpacka.dostawapodkarpacka')),
            ],
            options={
                'abstract': False,
            },
