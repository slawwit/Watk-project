...
from .views import licz_list, handle_licz, dostawy_list, dostawy_details, edit_dostawy, LicznikBazowyRudnaViewSet
from rest_framework import routers
from .api import UserAuthentication


router = routers.DefaultRouter()
router.register(r'liczniki', LicznikBazowyRudnaViewSet)


app_name = "rudna"
urlpatterns = [
    path('liczniki/', licz_list, name="liczniki"),
    path('dost/', dostawy_list, name="dost_rudna"),
