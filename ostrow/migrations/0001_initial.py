# Generated by Django 3.2.9 on 2023-03-15 07:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dostawca', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dost_ostrow', to='common.dostawcy')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('KIEDY', models.CharField(max_length=150)),
                ('KIEDY_WGR', models.DateTimeField(auto_now=True)),
                ('number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dost_licz_ostrow', to='ostrow.dostawaostrow')),
            ],
            options={
                'abstract': False,
            },
