    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dostawca', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dost_okuli', to='common.dostawcy')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='LicznikDostawyOkulickiego',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ID_DYS', models.PositiveSmallIntegerField()),
                ('ID_WAZ', models.PositiveSmallIntegerField()),
                ...
                ('KIEDY', models.CharField(max_length=150)),
                ('KIEDY_WGR', models.DateTimeField(auto_now=True)),
                ('number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dost_licz_okuli', to='okulickiego.dostawaokulickiego')),
            ],
            options={
                'abstract': False,
            },
